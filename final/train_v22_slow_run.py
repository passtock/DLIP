...
def run_fold(fold, records, args, device):
    ...
    optimizer = torch.optim.AdamW(trainable_params, lr=3e-5, weight_decay=1e-2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="/data/EunJi/h22000561_psa/v22_slow_learn")
